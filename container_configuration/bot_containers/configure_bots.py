...
HURDLE_BOT_NAME_PATTERN = "darpa-scoring-srn"
...
def configure_container_inet_device(client, cont_name, dev_name, address, parent, netmask, **kwargs):
    ...
    print("configure_container_inet_device called with extra arguments: {}".format(kwargs))
...
def main():
    ...
    parser.add_argument('--image-name', default="darpa-practice-srn-base-v1-0-0.tar.gz",
                        help=("The lxc image name we'll generate containers from," +
                              " assumed to be in /share/nas/competitor/images/"))
    parser.add_argument('--bot-type', choices=["practice", "scoring", "dummy"],

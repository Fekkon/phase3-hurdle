...
class env_sim_server_debug_outputs(gr.top_block):
    ...
    def get_eth0_addr(self):
        return self.eth0_addr

    def set_eth0_addr(self, eth0_addr):
        self.eth0_addr = eth0_addr
        self.set_zmq_base_addr("tcp://" + self.eth0_addr + ":")
...
def main(top_block_cls=env_sim_server_debug_outputs, options=None):
    if options is None:
